...
#define PAG_COMMIT  00000010  
#define PAG_READ    00000001
#define PAG_WRITE   00000002
#define PAG_EXECUTE 00000004
#define fPERM PAG_COMMIT|PAG_READ|PAG_WRITE
...
OS2EXPORT APIRET OS2API Dos32CancelLockRequest(HFILE hFile, PFILELOCK pflLock) OS2APIINFO(429);
OS2EXPORT APIRET OS2API Dos32CancelLockRequestL(HFILE hFile, PFILELOCKL pflLock) OS2APIINFO(987);
OS2EXPORT APIRET OS2API Dos32Copy(PSZ pszOld, PSZ pszNew, ULONG ulOptions) OS2APIINFO(258);
OS2EXPORT APIRET OS2API Dos32Move(PSZ  pszOld, PSZ  pszNew) OS2APIINFO(271);
OS2EXPORT APIRET OS2API DosSetFilePtrL(HFILE hFile, LONGLONG ib, ULONG method, PLONGLONG pibActual) OS2APIINFO(568);
OS2EXPORT APIRET OS2API DosEditName(ULONG metalevel, PSZ pszSource, PSZ pszEdit, PSZ pszTarget, ULONG cbTarget) OS2APIINFO(261);
...
OS2EXPORT APIRET OS2API DosAllocCreateSharedMem(PPVOID pBaseAddress, PSZ pszName, ULONG ulObjectSize, ULONG ulFlags, BOOL create) OS2APIINFO(1002);
